          ...
          <Row className="sec_sp presentation">
            ...
            <Col lg="7" className="d-flex align-items-center">
              <div className="about-txt">
                <p>Je suis un Développeur Web Front-End junior passionné, j'ai suivi une formation d'intégrateur web de 6 mois sur OpenClassrooms, renforçant mes compétences en HTML, CSS et JavaScript et maîtrisant les meilleures pratiques de conception d'interface utilisateur. Cette expérience m'a préparé à travailler de manière autonome et à respecter des délais serrés.<br /><br /> Spécialisé dans la création d'interfaces utilisateur conviviales et réactives. J'ai de bonnes connaissances dans les technologies front-end avec une préférence pour React.<br /><br />
